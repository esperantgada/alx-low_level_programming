...
-   By Julien Barbier
-   Ongoing project - started 08-27-2021, must end by 08-28-2021 (in about 3 hours) - you're done with 0% of tasks.
-   Checker was released at 08-27-2021 12:00 PM
...
```
julien@ubuntu:~/c/curriculum_by_julien/alx-low_level_programming/0x01$ gcc -Wall -pedantic -Werror -Wextra -std=gnu89 102-print_comb5.c -o 102-print_comb5
julien@ubuntu:~/c/curriculum_by_julien/alx-low_level_programming/0x01$ ./102-print_comb5
